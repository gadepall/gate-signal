...
\solution 
\newpage
\item Let $x(t) = 10 \cos(10.5 \omega t)$ be passed through an LTI system having impulse response $h(t) = \pi\left(\frac{\sin(\omega t)}{\pi t}\right)^2 \cos(10 \omega t)$ . The output of the system is:\\ \hfill(GATE EC 2023)
\solution
\newpage
\end{enumerate}
