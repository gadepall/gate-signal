...
\linebreak
(A) Discrete time Fourier transform of $x\sbrak{n}$ converges if $R$ is $|z|>3$\\
\linebreak
(B) Discrete time Fourier transform of $x\sbrak{n}$ converges if $ R$ is $\dfrac{2}{3}<|z|<3$\\
\linebreak
(C) Discrete time Fourier transform of $x\sbrak{n}$ converges if $R$ is such that $x\sbrak{n}$ is a left-sided sequence.\\
\linebreak
(D) Discrete time Fourier transform of $x\sbrak{n}$ converges if $R$ is such that $x\sbrak{n}$is a right-sided sequence.\\
\linebreak
\solution
\end{enumerate}
